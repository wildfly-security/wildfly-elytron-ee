 ...
 * RESTEasyClientConfigProviderImpl results in the correct service
...
public class ServiceFileGenerationTest {
    ...
    public void testServiceLoaderCanFindImplementation() {
        ...
        for (ClientConfigProvider provider : loader) {
            if (provider instanceof RESTEasyClientConfigProviderImpl) {
                found = true;
                break;
            }
        }
        assertTrue("ServiceLoader could not find RESTEasyClientConfigProviderImpl. " +
